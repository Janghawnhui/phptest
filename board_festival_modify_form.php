...
?>
	    <form  name="board_festival_form" method="post" action="board_festival_modify.php?num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data">
		<!--db에 저장된 정보 수정하기위해 board_modify파일에서 글 수정 폼 양식의 데이터를 전달받아 db에 업데이트-->
	    	 <ul id="board_form">
				<li>
